    ...
    return (
        <div className={styles.LogininWrapper}>
            <div style={{ marginLeft: "10%" }}>
                <img
                    src="https://www.thehindu.com/brandhub/d8b8gc/article26139666.ece/binary/dashboard-icon"
                    alt="newspaper-logo"
                />
            </div>
            <div className={styles.logoText}>
                <p>
                    Sign Up or Subscribe to set up <br /> your personalised
                    Dashboard
                </p>
            </div>
